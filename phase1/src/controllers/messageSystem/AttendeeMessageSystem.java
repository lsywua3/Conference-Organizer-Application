...
import useCase.messageManager.AttendeeMessageManager;

import java.util.InputMismatchException;

/**
 * Message system for attendee that takes user inputs and perform message operations.
 */
public class AttendeeMessageSystem extends MessageSystem {
     ...
     * Initializes AttendeeMessageManager mm, AccountManager accountManager, IGateway gate and IGateway userGate
     *
    ...
    public AttendeeMessageSystem(int user, AccountManager accountManager, IGateway gate, IGateway userGate) {
        ...
        mm = new AttendeeMessageManager((Messageable) accountManager.getUserById(user), gate);
    }
