...
public class OneSpeakerEvent extends Event {
    /**
     * Constructs a new UserEventManager with only one speaker.
     *
     ...
     */
    public OneSpeakerEvent(int id, String title, List<Integer> speakers, int room, int startTime, int duration,
                           int day, int capacity) {
        super(id, title, speakers, room, startTime, duration, day, capacity);
        this.type = "one speaker";
    }
