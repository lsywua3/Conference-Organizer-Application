...
public class NoSpeakerEvent extends Event {
    /**
     * Constructs a new UserEventManager with no speaker.
     *
     ...
     */
    public NoSpeakerEvent(int id, String title, List<Integer> speakers, int room, int startTime, int duration,
                          int day, int capacity) {
        super(id, title, speakers, room, startTime, duration, day, capacity);
        this.type = "no speaker";
    }
